...
public class EspecieController {
    ...
    public List<EspecieDTO> filtroExpectativa(
        @RequestParam Float maiorQue,
        @RequestParam Float menorQue
    ) {
        return especieService.buscarPorExpectativaVida(maiorQue.intValue(), menorQue.intValue());
    }

    @GetMapping("/grupo")
    public List<EspecieDTO> filtroGrupo(
        @RequestParam Integer minimo,
        @RequestParam Integer maximo
    ) {
        return especieService.buscarPorTamanhoGrupo(minimo, maximo);
    }
}
